...
SUPPORTED_CURRENCIES = {"EUR": "European euro","USD": "US dollar","GBP": "Pound sterling",
    "BRL": "Brazilian real"
}


CURRENCY_CODES = {1: "EUR",2: "USD",3: "GBP",4: "BRL"}
...
if __name__ == '__main__':
    ...
    while True:
        for code, currency in CURRENCY_CODES.items():
            print("option {}: from {}".format(code, currency))
    ...
    while True:
        for code, currency in CURRENCY_CODES.items():
            print("option {}: covert to {}".format(code, currency))
